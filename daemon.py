...
class Daemon:
    ...
    """
    def __init__(self, pidfile, stdin='/dev/null', stdout='/tmp/deamonlog.log', stderr='/dev/null'):
        self.stdin = stdin
        self.stdout = stdout
        self.stderr = stderr
    ...
    def daemonize(self):
        ...
        """
        print "DEBUG-daemon: daemonizing"
        try: 
            pid = os.fork() 
            if pid > 0:
                # exit first parent
    ...
    def start(self):
        ...
        # Start the daemon
        self.daemonize()
        print "DEBUG-daemon: calling run"
        self.run()
    ...
    def run(self):
        ...
        """
        print "DEBUG-daemon:  I think we should never be here.  It should be overridden"
